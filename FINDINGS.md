...
Measured main evaluation on libero_10. Coverage: complete for the explicitly selected horizons.

This report concerns the original native-P=10 main experiment. The separately
requested P=50 extension has its own [smoke-test findings](results/p50/FINDINGS.md):
...
|---:|---:|---:|---:|---:|---:|
| 5 | 460/500 | 92.0% | [89.3%, 94.1%] | 55.80 | 277.3 |
| 10 | 475/500 | 95.0% | [92.7%, 96.6%] | 26.90 | 264.4 |

## H=5 reproduction gate

H=5 measured 92.0%, versus the official 92.4% reference. The predeclared diagnostic gate allows at most a 5 percentage point deficit: PASS. This gate is a debugging screen, not an equivalence test; the public reference has no reported uncertainty here.
...
- H=10: gap -3.0 pp, paired 95% bootstrap CI [-5.6, -0.4] pp; 51.8% fewer calls per episode and 49.5% fewer calls per controlled step (500 pairs). Exact McNemar p (Holm-adjusted) = 0.0357.

## Interpretation

Measured success at H=10 was 3.0 percentage points higher than H=5.
...
- Task 8 at H=10: gap -22.0 pp (H=5 58.0%, H=10 80.0%) — put both moka pots on the stove.
- Task 9 at H=10: gap -10.0 pp (H=5 88.0%, H=10 98.0%) — put the yellow and white mug in the microwave and close it.
- Task 4 at H=10: gap +6.0 pp (H=5 100.0%, H=10 94.0%) — put the white mug on the left plate and put the yellow and white mug on the right plate.
- Task 2 at H=10: gap -4.0 pp (H=5 90.0%, H=10 94.0%) — turn on the stove and put the moka pot on it.
